...
const HomeFurniture = () => {
  const url =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/pages/category/Home-furniture/";

  const banner =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/static/category-banners/home-furniture-section";

  const { subCategory1 } = useParams();
  const { type1 } = useParams();
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(setCategory("Home-furniture"));
  }, []);
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      params.append("category", "Home-furniture");
        ...
        <div className="flex">
          ...
          <section className="hidden md:block min-w-40 min-h-[100vh] bg-blue-100/50 dark:bg-white/5">
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              <div className="grid grid-cols-3 px-2">
                {category["Home-furniture"]?.colours.map((colour) => {
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Home-furniture"]?.subCategoryTypes[subCategory]?.map(
                (Type) => (
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Home-furniture"]?.subCategoryBrands[subCategory]?.map(
                (Brand) => (
          ...
          >
            <section className="grid grid-cols-2 w-screen min-h-[80vh] bg-blue-100/50 dark:bg-gray-900 px-3">
              ...
              <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
                <h3 className="mb-1.5">Brand</h3>
                {category["Home-furniture"]?.subCategoryBrands[
                  subCategory
                ]?.map((Brand) => (
          ...
          <div className="overflow-x-hidden px-1 md:px-5">
            <div className="mt-5 mb-6 flex gap-3 md:gap-6 lg:gap-10 overflow-x-scroll hide-x-scrollbar">
              {category["Home-furniture"]?.subCategories.map(
                (category, index) => (
                  <button
                    key={category}
                    ...
                    <div
                      className={`${
                        subCategory === category
                          ? "border-t-purple-500/80 bg-purple-500/20"
                          : "border-t-transparent bg-purple-500/10"
                      } p-1.5 rounded-3xl border-t-3`}
                    >
                      <img
                        draggable="false"
                        loading="lazy"
                        ...
                        alt={category}
                        className="min-w-15 max-w-15 md:min-w-18 md:max-w-18 aspect-square"
                      />
                    </div>
