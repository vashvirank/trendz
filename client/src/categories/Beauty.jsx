...
const Beauty = () => {
  const url =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/pages/category/Beauty/";

  const banner =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/static/category-banners/beauty-section";
        ...
        <div className="flex">
          ...
          <section className="hidden md:block min-w-40 min-h-[100vh] bg-blue-100/50 dark:bg-white/5">
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              <div className="grid grid-cols-3 px-2">
                {category["Beauty"]?.colours.map((colour) => {
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Beauty"]?.subCategoryTypes[subCategory]?.map(
                (Type) => (
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Beauty"]?.subCategoryBrands[subCategory]?.map(
                (Brand) => (
          ...
          <div className="overflow-x-hidden px-1 md:px-5">
            <div className="mt-5 mb-6 flex gap-3 md:gap-6 lg:gap-10 overflow-x-scroll hide-x-scrollbar">
              {category["Beauty"]?.subCategories.map((category, index) => (
                <button
                  key={category}
                ...
                >
                  <div
                    className={`${
                      subCategory === category
                        ? "border-l-indigo-500/80 bg-indigo-500/30"
                        : "border-l-transparent bg-indigo-500/20"
                    } p-1 rounded-bl-xl rounded-tr-4xl border-l-3`}
                  >
                    <img
                      draggable="false"
                      loading="lazy"
                  ...
                  <p className="text-xs pt-1">{category}</p>
                </button>
              ))}
