...
const Grocery = () => {
  const url =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/pages/category/Grocery/";

  const banner =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/static/category-banners/grocery-section";

  const { subCategory1 } = useParams();
  const { type1 } = useParams();
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(setCategory("Grocery"));
  }, []);
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      params.append("category", "Grocery");
        ...
        <div className="flex">
          ...
          <section className="hidden md:block min-w-40 min-h-[100vh] bg-blue-100/50 dark:bg-white/5">
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              <div className="grid grid-cols-3 px-2">
                {category["Grocery"]?.colours.map((colour) => {
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Grocery"]?.subCategoryTypes[subCategory]?.map(
                (Type) => (
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Grocery"]?.subCategoryBrands[subCategory]?.map(
                (Brand) => (
          ...
          <div className="overflow-x-hidden px-1 md:px-5">
            <div className="mt-5 mb-6 flex gap-3 md:gap-6 lg:gap-10 overflow-x-scroll hide-x-scrollbar">
              {category["Grocery"]?.subCategories.map((category, index) => (
                <button
                  key={category}
                  ...
                  <div
                    className={`${
                      subCategory === category
                        ? "border-b-green-400/80 bg-green-400/20"
                        : "border-b-transparent bg-green-400/10"
                    } p-1.5 rounded-tl-3xl rounded-br-3xl border-b-3`}
                  >
                    <img
                      draggable="false"
                      loading="lazy"
