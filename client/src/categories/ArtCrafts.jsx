...
const ArtCrafts = () => {
  const url =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/pages/category/Art-crafts/";

  const banner =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/static/category-banners/art-craft-section";

  const { subCategory1 } = useParams();
  const { type1 } = useParams();
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(setCategory("Art-crafts"));
  }, []);
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      params.append("category", "Art-crafts");
      ...
      <div className="bg-blue-50 dark:bg-gray-950/80 text-gray-700 dark:text-gray-300">
        ...
        <div className="flex">
          ...
          <section className="hidden md:block min-w-40 min-h-[100vh] bg-blue-100/50 dark:bg-white/5">
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              <div className="grid grid-cols-3 px-2">
                {category["Art-crafts"]?.colours.map((colour) => {
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Art-crafts"]?.subCategoryTypes[subCategory]?.map(
                (Type) => (
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Art-crafts"]?.subCategoryBrands[subCategory]?.map(
                (Brand) => (
          ...
          <div className="overflow-x-hidden px-1 md:px-5">
            <div className="mt-5 mb-6 flex gap-2 md:gap-6 lg:gap-10 overflow-x-scroll hide-x-scrollbar">
              {category["Art-crafts"]?.subCategories.map((category, index) => (
                <button
                  key={category}
                  ...
                  <div
                    className={`${
                      subCategory === category
                        ? "border-b-pink-400/80 bg-pink-400/30"
                        : "border-b-transparent bg-pink-400/20"
                    } p-4 rounded-full border-b-3`}
                  >
                    <img
                      draggable="false"
                      loading="lazy"
                      ...
                      alt={category}
                      className="w-16 md:w-16 aspect-square"
                    />
                  </div>
