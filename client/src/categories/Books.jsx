...
const Books = () => {
  const url =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/pages/category/Books/";

  const banner =
    "https://res.cloudinary.com/dsror8r39/image/upload/v1742750135/trendz/static/category-banners/books-section";

  const { subCategory1 } = useParams();
  const { type1 } = useParams();
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(setCategory("Books"));
  }, []);
        ...
        <div className="flex">
          ...
          <section className="hidden md:block min-w-40 min-h-[100vh] bg-blue-100/50 dark:bg-white/5">
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              <div className="grid grid-cols-3 px-2">
                {category["Books"]?.colours.map((colour) => {
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Books"]?.subCategoryTypes[subCategory]?.map((Type) => (
            ...
            <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
              ...
              {category["Books"]?.subCategoryBrands[subCategory]?.map(
                (Brand) => (
          ...
          >
            <section className="grid grid-cols-2 w-screen min-h-[80vh] bg-blue-100/50 dark:bg-gray-900 px-3">
              ...
              <div className="p-3 border-t border-t-black/10 dark:border-t-white/10">
                <h3 className="mb-1.5">Type</h3>
                {category["Books"]?.subCategoryTypes[subCategory]?.map(
                  (Type) => (
          ...
          <div className="overflow-x-hidden px-1 md:px-5">
            <div className="mt-5 mb-6 flex gap-3 md:gap-6 lg:gap-10 overflow-x-scroll hide-x-scrollbar">
              {category["Books"]?.subCategories.map((category, index) => (
                <button
                  key={category}
                  ...
                  <div
                    className={`${
                      subCategory === category
                        ? "border-t-lime-400/80 bg-lime-400/20"
                        : "border-t-transparent bg-lime-400/10"
                    } p-1.5 rounded-b-3xl border-t-3`}
                  >
                    <img
                      draggable="false"
                      loading="lazy"
