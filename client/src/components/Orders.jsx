...
const Orders = () => {
  ...
  return (
    <>
      ...
      <div>
        <div className="bg-blue-50 dark:bg-gray-900 min-h-[100vh]">
          <h3 className="text-center text-blue-400 text-2xl p-5">
            Your Orders
          </h3>
          <div>
            <div>
              {loading ? (
                ...
                <>
                  {orders && orders?.length !== 0 ? (
                    <ul className="px-1 md:px-5 mx-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                      {orders?.map((order) => (
                        <li
                          key={order?._id}
